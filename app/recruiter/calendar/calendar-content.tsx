...
export function RecruiterCalendarContent() {
            ...
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Connect your Google Calendar to schedule interviews
                </p>
              </div>
              {isConnected ? (
            ...
            <div className="space-y-4">
              <div className="p-4 bg-dark-700 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-purple-400" />
                    Conflict prevention with your calendar
                  </li>
                </ul>
              </div>
      ...
      <FadeIn delay={400}>
        <AnimatedCard variant="hover-glow" className="p-6 mt-6">
          ...
          <p className="text-sm text-gray-400 mb-6">
            Set your available hours for conducting interviews. Candidates will only be able to book time slots within these hours.
          </p>

    ...
    async function fetchProfile() {
      try {
        ...
        if (user) {
          ...
          // Check if profile is complete to determine if we should show tooltips
          const isProfileComplete = Object.values(user.user_metadata || {}).some(value => value && typeof value === 'string' && value.length > 0)
          setShowTooltips(!isProfileComplete)
        }
      } catch (err: any) {
        console.error(err)
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              ...
              <div className="flex-1 space-y-4">
                ...
                <Tooltip open={showTooltips}>
                  ...
                  <TooltipContent className="bg-purple-500/90 text-white border-none">
                    <p>Keep your email updated to receive new opportunities</p>
                  </TooltipContent>
                </Tooltip>
                ...
                <Tooltip open={showTooltips}>
                  ...
                  <TooltipContent className="bg-purple-500/90 text-white border-none">
                    <p>Add your phone number for direct communication with recruiters</p>
                  </TooltipContent>
                </Tooltip>
                ...
                <Tooltip open={showTooltips}>
                  ...
                  <TooltipContent className="bg-purple-500/90 text-white border-none">
                    <p>Add a professional bio to showcase your experience and expertise</p>
                  </TooltipContent>
                </Tooltip>
              </div>
            </div>
          ...
          <Tabs defaultValue="background" className="w-full">
            <TabsList className="grid grid-cols-5 bg-dark-700 p-1 mb-6">
              <Tooltip open={showTooltips}>
                ...
                <TooltipContent className="bg-purple-500/90 text-white border-none">
                  <p>Add more details about your sales achievements and experience</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip open={showTooltips}>
                ...
                <TooltipContent className="bg-purple-500/90 text-white border-none">
                  <p>Share more about your unique approach to sales and client interactions</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip open={showTooltips}>
                ...
                <TooltipContent className="bg-purple-500/90 text-white border-none">
                  <p>Add details about your daily routine and follow-up processes</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip open={showTooltips}>
                ...
                <TooltipContent className="bg-purple-500/90 text-white border-none">
                  <p>Share more about your resilience and growth mindset</p>
                </TooltipContent>
              </Tooltip>
